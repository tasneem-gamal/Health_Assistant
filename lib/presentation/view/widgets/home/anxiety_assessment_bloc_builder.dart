...
class AnxietyAssessmentBlocBuilder extends StatefulWidget {
...
class _AnxietyAssessmentBlocBuilderState extends State<AnxietyAssessmentBlocBuilder> {
  int currentIndex = 0;
        ...
        if (state is AssessmentLoading) {
          ...
          final anxietyAssessments = state.assessments
              .where((e) => e.assessmentTitle
                  .toLowerCase()
                  .contains("anxiety assessment"))
              .toList();

          if (anxietyAssessments.isEmpty) {
            return const Center(child: Text("Anxiety Assessment not found"));
          }
